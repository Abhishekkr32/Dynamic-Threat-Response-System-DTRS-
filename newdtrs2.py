...
# Updated blacklist
blacklist = ["malware.exe", "virus.exe", "keylogger.exe", "spam_cpu.exe", "file_replicator.exe"]
whitelist = ["explorer.exe", "notepad.exe", "cmd.exe"]

# Email configuration
EMAIL_FROM = "abhisaroj226002@gmail.com"
EMAIL_TO = "mrmonuswami8@gmail.com"
...
def scan_and_terminate():
    ...
    for process in psutil.process_iter(attrs=["pid", "name"]):
        try:
            ...
            print(process_name)  # Debug line for visibility

            if process_name.lower() in [item.lower() for item in blacklist]:
    ...
    root.after(5000, scan_and_terminate)
